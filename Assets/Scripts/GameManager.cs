...
public class GameManager : MonoBehaviour
{
    ...
    public SpriteRenderer clockwiseSprite;
    ...
    void RotateArm()
    {
        ...
        clockwise.RotateAround(pivotPoint.position, Vector3.forward, angle);
        CreateAfterImage();
        ...
        if (reachedDot != null)
        {
            ...
            clockwise.RotateAround(pivotPoint.position, Vector3.forward, angleToSnap);
            isRotating = false;
    ...
    void CreateAfterImage()
    {
        ...
        afterImage.transform.position = clockwise.position;
        afterImage.transform.rotation = clockwise.rotation;
        afterImage.transform.localScale = clockwise.localScale;

        SpriteRenderer sr = afterImage.AddComponent<SpriteRenderer>();
        sr.sprite = clockwiseSprite.sprite;
        sr.sortingOrder = clockwiseSprite.sortingOrder - 1;
